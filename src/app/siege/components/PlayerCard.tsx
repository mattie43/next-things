...
export const PlayerCard = ({
    ...
    return (
        <div
            style={{
                display: "flex",
                border: `2px solid ${pastelColors[ind % 5]}`,
                padding: "0.5em",
                margin: "0 0.5em",
        ...
        >
            ...
            {openStats && (
                ...
                >
                    <Typography>
                        Overall Rating: {player.stats?.rating}
                    </Typography>
                    <div
                        style={{
                            marginTop: "1em",
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Image
                                    src={
                                        player.stats?.operators?.atk
                                            ?.logo_url || ""
                                    }
                                    height={72}
                                    width={69}
                                    alt={
                                        player.stats?.operators?.atk?.name || ""
                                    }
                                />
                            </Tooltip>
                        </Typography>
                        ...
                        >
                            ...
                            >
                                <Image
                                    src={
                                        player.stats?.operators?.def
                                            ?.logo_url || ""
                                    }
                                    height={72}
                                    width={69}
                                    alt={
                                        player.stats?.operators?.def?.name || ""
                                    }
                                />
                            </Tooltip>
                        </Typography>
